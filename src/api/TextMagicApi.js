...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {Array.<module:model/ImportColumnMappingItem>} column 
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    this.importContactsWithHttpInfo = function(file, column) {
      var postBody = null;
      ...
      var formParams = {
        'file': file,
        'column': this.apiClient.buildCollectionParam(column, 'csv')
      };
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}
     */
    this.importContacts = function(file, column) {
      return this.importContactsWithHttpInfo(file, column)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
