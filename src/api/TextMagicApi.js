...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TextmagicRest.TextMagicApi = factory(root.TextmagicRest.ApiClient, root.TextmagicRest.AssignContactsToListInputObject, root.TextmagicRest.BadRequestResponse, root.TextmagicRest.BlockContactInputObject, root.TextmagicRest.BulkSession, root.TextmagicRest.BuyDedicatedNumberInputObject, root.TextmagicRest.Chat, root.TextmagicRest.CheckPhoneVerificationCodeInputObject, root.TextmagicRest.ClearAndAssignContactsToListInputObject, root.TextmagicRest.CloseChatsBulkInputObject, root.TextmagicRest.Contact, root.TextmagicRest.ContactNote, root.TextmagicRest.Country, root.TextmagicRest.CreateContactInputObject, root.TextmagicRest.CreateContactNoteInputObject, root.TextmagicRest.CreateCustomFieldInputObject, root.TextmagicRest.CreateListInputObject, root.TextmagicRest.CreatePushTokenInputObject, root.TextmagicRest.CreateSurveyInputObject, root.TextmagicRest.CreateSurveyNodeInputObject, root.TextmagicRest.CreateTemplateInputObject, root.TextmagicRest.DeleteChatMessagesBulkInputObject, root.TextmagicRest.DeleteChatsBulkInputObject, root.TextmagicRest.DeleteContacsFromListObject, root.TextmagicRest.DeleteContactNotesBulkInputObject, root.TextmagicRest.DeleteContactsByIdsInputObject, root.TextmagicRest.DeleteInboundMessagesBulkInputObject, root.TextmagicRest.DeleteListContactsBulkInputObject, root.TextmagicRest.DeleteListsBulkInputObject, root.TextmagicRest.DeleteMessageSessionsBulkInputObject, root.TextmagicRest.DeleteOutboundMessagesBulkInputObject, root.TextmagicRest.DeleteScheduledMessagesBulkInputObject, root.TextmagicRest.DeleteTemplatesBulkInputObject, root.TextmagicRest.DoAuthInputObject, root.TextmagicRest.DoAuthResponse, root.TextmagicRest.DoCarrierLookupResponse, root.TextmagicRest.DoEmailLookupResponse, root.TextmagicRest.GetAllBulkSessionsResponse, root.TextmagicRest.GetAllChatsResponse, root.TextmagicRest.GetAllInboundMessagesResponse, root.TextmagicRest.GetAllMessageSessionsResponse, root.TextmagicRest.GetAllOutboundMessagesResponse, root.TextmagicRest.GetAllScheduledMessagesResponse, root.TextmagicRest.GetAllTemplatesResponse, root.TextmagicRest.GetAvailableDedicatedNumbersResponse, root.TextmagicRest.GetAvailableSenderSettingOptionsResponse, root.TextmagicRest.GetBalanceNotificationOptionsResponse, root.TextmagicRest.GetBalanceNotificationSettingsResponse, root.TextmagicRest.GetBlockedContactsResponse, root.TextmagicRest.GetCallbackSettingsResponse, root.TextmagicRest.GetChatMessagesResponse, root.TextmagicRest.GetContactImportSessionProgressResponse, root.TextmagicRest.GetContactNotesResponse, root.TextmagicRest.GetContactsAutocompleteResponse, root.TextmagicRest.GetContactsByListIdResponse, root.TextmagicRest.GetContactsResponse, root.TextmagicRest.GetCustomFieldsResponse, root.TextmagicRest.GetFavouritesResponse, root.TextmagicRest.GetForwardedCallsResponse, root.TextmagicRest.GetInboundMessagesNotificationSettingsResponse, root.TextmagicRest.GetInvoicesResponse, root.TextmagicRest.GetListContactsIdsResponse, root.TextmagicRest.GetListsOfContactResponse, root.TextmagicRest.GetMessagePreviewResponse, root.TextmagicRest.GetMessagePriceResponse, root.TextmagicRest.GetMessagePricesResponse, root.TextmagicRest.GetMessageSessionStatResponse, root.TextmagicRest.GetMessagesBySessionIdResponse, root.TextmagicRest.GetMessagingCountersResponse, root.TextmagicRest.GetMessagingStatResponse, root.TextmagicRest.GetOutboundMessagesHistoryResponse, root.TextmagicRest.GetPushTokensResponse, root.TextmagicRest.GetSenderIdsResponse, root.TextmagicRest.GetSenderSettingsResponse, root.TextmagicRest.GetSpendingStatResponse, root.TextmagicRest.GetStateResponse, root.TextmagicRest.GetSubaccountsWithTokensInputObject, root.TextmagicRest.GetSubaccountsWithTokensResponse, root.TextmagicRest.GetSurveyNodesResponse, root.TextmagicRest.GetSurveysResponse, root.TextmagicRest.GetUnreadMessagesTotalResponse, root.TextmagicRest.GetUnsubscribersResponse, root.TextmagicRest.GetUserDedicatedNumbersResponse, root.TextmagicRest.GetUserListsResponse, root.TextmagicRest.GetVersionsResponse, root.TextmagicRest.Group, root.TextmagicRest.InviteSubaccountInputObject, root.TextmagicRest.MarkChatsReadBulkInputObject, root.TextmagicRest.MarkChatsUnreadBulkInputObject, root.TextmagicRest.MergeSurveyNodesInputObject, root.TextmagicRest.MessageIn, root.TextmagicRest.MessageOut, root.TextmagicRest.MessageSession, root.TextmagicRest.MessageTemplate, root.TextmagicRest.MessagesIcs, root.TextmagicRest.MuteChatInputObject, root.TextmagicRest.MuteChatsBulkInputObject, root.TextmagicRest.NotFoundResponse, root.TextmagicRest.PingResponse, root.TextmagicRest.ReopenChatsBulkInputObject, root.TextmagicRest.RequestNewSubaccountTokenInputObject, root.TextmagicRest.RequestSenderIdInputObject, root.TextmagicRest.ResourceLinkResponse, root.TextmagicRest.SearchChatsByIdsResponse, root.TextmagicRest.SearchChatsByReceipentResponse, root.TextmagicRest.SearchChatsResponse, root.TextmagicRest.SearchContactsResponse, root.TextmagicRest.SearchInboundMessagesResponse, root.TextmagicRest.SearchListsResponse, root.TextmagicRest.SearchOutboundMessagesResponse, root.TextmagicRest.SearchScheduledMessagesResponse, root.TextmagicRest.SearchTemplatesResponse, root.TextmagicRest.SendMessageInputObject, root.TextmagicRest.SendMessageResponse, root.TextmagicRest.SenderId, root.TextmagicRest.SetChatStatusInputObject, root.TextmagicRest.Survey, root.TextmagicRest.SurveyNode, root.TextmagicRest.UnauthorizedResponse, root.TextmagicRest.UnblockContactInputObject, root.TextmagicRest.UnblockContactsBulkInputObject, root.TextmagicRest.UnmuteChatsBulkInputObject, root.TextmagicRest.UnsubscribeContactInputObject, root.TextmagicRest.UnsubscribedContact, root.TextmagicRest.UpdateBalanceNotificationSettingsInputObject, root.TextmagicRest.UpdateCallbackSettingsInputObject, root.TextmagicRest.UpdateChatDesktopNotificationSettingsInputObject, root.TextmagicRest.UpdateContactInputObject, root.TextmagicRest.UpdateContactNoteInputObject, root.TextmagicRest.UpdateCurrentUserInputObject, root.TextmagicRest.UpdateCurrentUserResponse, root.TextmagicRest.UpdateCustomFieldInputObject, root.TextmagicRest.UpdateCustomFieldValueInputObject, root.TextmagicRest.UpdateInboundMessagesNotificationSettingsInputObject, root.TextmagicRest.UpdateListObject, root.TextmagicRest.UpdatePasswordInputObject, root.TextmagicRest.UpdateSenderSettingInputObject, root.TextmagicRest.UpdateSurveyInputObject, root.TextmagicRest.UpdateSurveyNodeInputObject, root.TextmagicRest.UpdateTemplateInputObject, root.TextmagicRest.UploadMessageAttachmentResponse, root.TextmagicRest.User, root.TextmagicRest.UserCustomField, root.TextmagicRest.UsersInbound);
  }
