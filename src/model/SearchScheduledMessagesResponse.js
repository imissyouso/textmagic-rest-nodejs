...
(function(root, factory) {
  ...
  /**
   * Constructs a new <code>SearchScheduledMessagesResponse</code>.
   * @alias module:model/SearchScheduledMessagesResponse
   * @class
   * @param page {Number} 
  ...
  /**
   * Constructs a <code>SearchScheduledMessagesResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SearchScheduledMessagesResponse} obj Optional instance to populate.
   * @return {module:model/SearchScheduledMessagesResponse} The populated <code>SearchScheduledMessagesResponse</code> instance.
   */
