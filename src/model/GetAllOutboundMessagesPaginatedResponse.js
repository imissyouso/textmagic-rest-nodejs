...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TextmagicClient.GetAllOutboundMessagesPaginatedResponse = factory(root.TextmagicClient.ApiClient, root.TextmagicClient.MessageOut);
  }
  ...
  /**
   * Constructs a new <code>GetAllOutboundMessagesPaginatedResponse</code>.
   * @alias module:model/GetAllOutboundMessagesPaginatedResponse
   * @class
   * @param page {Number} 
  ...
  /**
   * Constructs a <code>GetAllOutboundMessagesPaginatedResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetAllOutboundMessagesPaginatedResponse} obj Optional instance to populate.
   * @return {module:model/GetAllOutboundMessagesPaginatedResponse} The populated <code>GetAllOutboundMessagesPaginatedResponse</code> instance.
   */
