...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TextmagicClient.GetAllInboundMessagesResponse = factory(root.TextmagicClient.ApiClient, root.TextmagicClient.MessageIn);
  }
  ...
  /**
   * Constructs a new <code>GetAllInboundMessagesResponse</code>.
   * @alias module:model/GetAllInboundMessagesResponse
   * @class
   * @param page {Number} 
  ...
  /**
   * Constructs a <code>GetAllInboundMessagesResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetAllInboundMessagesResponse} obj Optional instance to populate.
   * @return {module:model/GetAllInboundMessagesResponse} The populated <code>GetAllInboundMessagesResponse</code> instance.
   */
