...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TextmagicClient.GetOutboundMessagesHistoryResponse = factory(root.TextmagicClient.ApiClient, root.TextmagicClient.MessageOut);
  }
  ...
  /**
   * Constructs a new <code>GetOutboundMessagesHistoryResponse</code>.
   * @alias module:model/GetOutboundMessagesHistoryResponse
   * @class
   * @param lastId {Number} 
  ...
  /**
   * Constructs a <code>GetOutboundMessagesHistoryResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetOutboundMessagesHistoryResponse} obj Optional instance to populate.
   * @return {module:model/GetOutboundMessagesHistoryResponse} The populated <code>GetOutboundMessagesHistoryResponse</code> instance.
   */
