...
(function(root, factory) {
  ...
  /**
   * Constructs a new <code>GetMessagesBySessionIdResponse</code>.
   * @alias module:model/GetMessagesBySessionIdResponse
   * @class
   * @param page {Number} 
  ...
  /**
   * Constructs a <code>GetMessagesBySessionIdResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetMessagesBySessionIdResponse} obj Optional instance to populate.
   * @return {module:model/GetMessagesBySessionIdResponse} The populated <code>GetMessagesBySessionIdResponse</code> instance.
   */
