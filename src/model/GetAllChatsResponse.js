...
(function(root, factory) {
  ...
  /**
   * Constructs a new <code>GetAllChatsResponse</code>.
   * @alias module:model/GetAllChatsResponse
   * @class
   * @param page {Number} 
  ...
  /**
   * Constructs a <code>GetAllChatsResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetAllChatsResponse} obj Optional instance to populate.
   * @return {module:model/GetAllChatsResponse} The populated <code>GetAllChatsResponse</code> instance.
   */
