...
(function(root, factory) {
  ...
  /**
   * Constructs a new <code>GetAllMessageSessionsResponse</code>.
   * @alias module:model/GetAllMessageSessionsResponse
   * @class
   * @param page {Number} 
  ...
  /**
   * Constructs a <code>GetAllMessageSessionsResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetAllMessageSessionsResponse} obj Optional instance to populate.
   * @return {module:model/GetAllMessageSessionsResponse} The populated <code>GetAllMessageSessionsResponse</code> instance.
   */
