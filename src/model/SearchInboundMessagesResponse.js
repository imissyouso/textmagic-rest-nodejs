...
(function(root, factory) {
  ...
  /**
   * Constructs a new <code>SearchInboundMessagesResponse</code>.
   * @alias module:model/SearchInboundMessagesResponse
   * @class
   * @param page {Number} 
  ...
  /**
   * Constructs a <code>SearchInboundMessagesResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SearchInboundMessagesResponse} obj Optional instance to populate.
   * @return {module:model/SearchInboundMessagesResponse} The populated <code>SearchInboundMessagesResponse</code> instance.
   */
