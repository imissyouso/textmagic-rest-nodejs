...
(function(root, factory) {
  ...
  /**
   * Constructs a new <code>SearchListsPaginatedResponse</code>.
   * @alias module:model/SearchListsPaginatedResponse
   * @class
   * @param page {Number} 
  ...
  /**
   * Constructs a <code>SearchListsPaginatedResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SearchListsPaginatedResponse} obj Optional instance to populate.
   * @return {module:model/SearchListsPaginatedResponse} The populated <code>SearchListsPaginatedResponse</code> instance.
   */
