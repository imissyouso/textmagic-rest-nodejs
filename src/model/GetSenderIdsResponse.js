...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/SenderId'], factory);
  ...
  /**
   * Constructs a new <code>GetSenderIdsResponse</code>.
   * @alias module:model/GetSenderIdsResponse
   * @class
   * @param page {Number} 
  ...
  /**
   * Constructs a <code>GetSenderIdsResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetSenderIdsResponse} obj Optional instance to populate.
   * @return {module:model/GetSenderIdsResponse} The populated <code>GetSenderIdsResponse</code> instance.
   */
