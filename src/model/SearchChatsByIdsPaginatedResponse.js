...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TextmagicClient.SearchChatsByIdsPaginatedResponse = factory(root.TextmagicClient.ApiClient, root.TextmagicClient.Chat);
  }
  ...
  /**
   * Constructs a new <code>SearchChatsByIdsPaginatedResponse</code>.
   * @alias module:model/SearchChatsByIdsPaginatedResponse
   * @class
   * @param page {Number} 
  ...
  /**
   * Constructs a <code>SearchChatsByIdsPaginatedResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SearchChatsByIdsPaginatedResponse} obj Optional instance to populate.
   * @return {module:model/SearchChatsByIdsPaginatedResponse} The populated <code>SearchChatsByIdsPaginatedResponse</code> instance.
   */
