...
(function(root, factory) {
  ...
  /**
   * Constructs a new <code>SearchChatsByIdsResponse</code>.
   * @alias module:model/SearchChatsByIdsResponse
   * @class
   * @param page {Number} 
  ...
  /**
   * Constructs a <code>SearchChatsByIdsResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SearchChatsByIdsResponse} obj Optional instance to populate.
   * @return {module:model/SearchChatsByIdsResponse} The populated <code>SearchChatsByIdsResponse</code> instance.
   */
