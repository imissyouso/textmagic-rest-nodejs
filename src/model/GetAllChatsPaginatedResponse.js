...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TextmagicClient.GetAllChatsPaginatedResponse = factory(root.TextmagicClient.ApiClient, root.TextmagicClient.Chat);
  }
  ...
  /**
   * Constructs a new <code>GetAllChatsPaginatedResponse</code>.
   * @alias module:model/GetAllChatsPaginatedResponse
   * @class
   * @param page {Number} 
  ...
  /**
   * Constructs a <code>GetAllChatsPaginatedResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetAllChatsPaginatedResponse} obj Optional instance to populate.
   * @return {module:model/GetAllChatsPaginatedResponse} The populated <code>GetAllChatsPaginatedResponse</code> instance.
   */
