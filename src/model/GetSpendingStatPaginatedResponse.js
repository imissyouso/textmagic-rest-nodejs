...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TextmagicClient.GetSpendingStatPaginatedResponse = factory(root.TextmagicClient.ApiClient, root.TextmagicClient.UserStatement);
  }
  ...
  /**
   * Constructs a new <code>GetSpendingStatPaginatedResponse</code>.
   * @alias module:model/GetSpendingStatPaginatedResponse
   * @class
   * @param page {Number} 
  ...
  /**
   * Constructs a <code>GetSpendingStatPaginatedResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetSpendingStatPaginatedResponse} obj Optional instance to populate.
   * @return {module:model/GetSpendingStatPaginatedResponse} The populated <code>GetSpendingStatPaginatedResponse</code> instance.
   */
