...
(function(root, factory) {
  ...
  /**
   * Constructs a new <code>GetSurveysResponse</code>.
   * @alias module:model/GetSurveysResponse
   * @class
   * @param page {Number} 
  ...
  /**
   * Constructs a <code>GetSurveysResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetSurveysResponse} obj Optional instance to populate.
   * @return {module:model/GetSurveysResponse} The populated <code>GetSurveysResponse</code> instance.
   */
