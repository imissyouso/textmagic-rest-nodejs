...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TextmagicClient.GetContactsByListIdPaginatedResponse = factory(root.TextmagicClient.ApiClient, root.TextmagicClient.Contact);
  }
  ...
  /**
   * Constructs a new <code>GetContactsByListIdPaginatedResponse</code>.
   * @alias module:model/GetContactsByListIdPaginatedResponse
   * @class
   * @param page {Number} 
  ...
  /**
   * Constructs a <code>GetContactsByListIdPaginatedResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetContactsByListIdPaginatedResponse} obj Optional instance to populate.
   * @return {module:model/GetContactsByListIdPaginatedResponse} The populated <code>GetContactsByListIdPaginatedResponse</code> instance.
   */
