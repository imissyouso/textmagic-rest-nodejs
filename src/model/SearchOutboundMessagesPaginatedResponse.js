...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TextmagicClient.SearchOutboundMessagesPaginatedResponse = factory(root.TextmagicClient.ApiClient, root.TextmagicClient.MessageOut);
  }
  ...
  /**
   * Constructs a new <code>SearchOutboundMessagesPaginatedResponse</code>.
   * @alias module:model/SearchOutboundMessagesPaginatedResponse
   * @class
   * @param page {Number} 
  ...
  /**
   * Constructs a <code>SearchOutboundMessagesPaginatedResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SearchOutboundMessagesPaginatedResponse} obj Optional instance to populate.
   * @return {module:model/SearchOutboundMessagesPaginatedResponse} The populated <code>SearchOutboundMessagesPaginatedResponse</code> instance.
   */
