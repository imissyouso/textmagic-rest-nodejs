...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TextmagicClient.ReopenChatsBulkInputObject = factory(root.TextmagicClient.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>ReopenChatsBulkInputObject</code>.
   * @alias module:model/ReopenChatsBulkInputObject
   * @class
   */
  ...
  /**
   * Constructs a <code>ReopenChatsBulkInputObject</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ReopenChatsBulkInputObject} obj Optional instance to populate.
   * @return {module:model/ReopenChatsBulkInputObject} The populated <code>ReopenChatsBulkInputObject</code> instance.
   */
