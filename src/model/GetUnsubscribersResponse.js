...
(function(root, factory) {
  ...
  /**
   * Constructs a new <code>GetUnsubscribersResponse</code>.
   * @alias module:model/GetUnsubscribersResponse
   * @class
   * @param page {Number} 
  ...
  /**
   * Constructs a <code>GetUnsubscribersResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetUnsubscribersResponse} obj Optional instance to populate.
   * @return {module:model/GetUnsubscribersResponse} The populated <code>GetUnsubscribersResponse</code> instance.
   */
