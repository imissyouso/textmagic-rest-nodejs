...
(function(root, factory) {
  ...
  /**
   * Constructs a new <code>GetAllBulkSessionsResponse</code>.
   * @alias module:model/GetAllBulkSessionsResponse
   * @class
   * @param page {Number} 
  ...
  /**
   * Constructs a <code>GetAllBulkSessionsResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetAllBulkSessionsResponse} obj Optional instance to populate.
   * @return {module:model/GetAllBulkSessionsResponse} The populated <code>GetAllBulkSessionsResponse</code> instance.
   */
