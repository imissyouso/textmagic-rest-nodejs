...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TextmagicRest.SendMessageInputObject();
  });
  ...
  describe('SendMessageInputObject', function() {
    it('should create an instance of SendMessageInputObject', function() {
      ...
      //var instance = new TextmagicRest.SendMessageInputObject();
      //expect(instance).to.be.a(TextmagicRest.SendMessageInputObject);
    });
