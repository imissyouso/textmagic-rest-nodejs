...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TextmagicClient.GetAllBulkSessionsResponse();
  });
  ...
  describe('GetAllBulkSessionsResponse', function() {
    it('should create an instance of GetAllBulkSessionsResponse', function() {
      // uncomment below and update the code to test GetAllBulkSessionsResponse
      //var instance = new TextmagicClient.GetAllBulkSessionsResponse();
      //expect(instance).to.be.a(TextmagicClient.GetAllBulkSessionsResponse);
    });
