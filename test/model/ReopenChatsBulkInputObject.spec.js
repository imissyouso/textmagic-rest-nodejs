...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TextmagicClient.ReopenChatsBulkInputObject();
  });
  ...
  describe('ReopenChatsBulkInputObject', function() {
    it('should create an instance of ReopenChatsBulkInputObject', function() {
      // uncomment below and update the code to test ReopenChatsBulkInputObject
      //var instance = new TextmagicClient.ReopenChatsBulkInputObject();
      //expect(instance).to.be.a(TextmagicClient.ReopenChatsBulkInputObject);
    });
