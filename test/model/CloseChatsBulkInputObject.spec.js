...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TextmagicClient.CloseChatsBulkInputObject();
  });
  ...
  describe('CloseChatsBulkInputObject', function() {
    it('should create an instance of CloseChatsBulkInputObject', function() {
      // uncomment below and update the code to test CloseChatsBulkInputObject
      //var instance = new TextmagicClient.CloseChatsBulkInputObject();
      //expect(instance).to.be.a(TextmagicClient.CloseChatsBulkInputObject);
    });
