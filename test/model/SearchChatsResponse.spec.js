...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TextmagicClient.SearchChatsResponse();
  });
  ...
  describe('SearchChatsResponse', function() {
    it('should create an instance of SearchChatsResponse', function() {
      // uncomment below and update the code to test SearchChatsResponse
      //var instance = new TextmagicClient.SearchChatsResponse();
      //expect(instance).to.be.a(TextmagicClient.SearchChatsResponse);
    });
