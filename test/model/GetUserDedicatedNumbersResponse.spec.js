...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TextmagicClient.GetUserDedicatedNumbersResponse();
  });
  ...
  describe('GetUserDedicatedNumbersResponse', function() {
    it('should create an instance of GetUserDedicatedNumbersResponse', function() {
      // uncomment below and update the code to test GetUserDedicatedNumbersResponse
      //var instance = new TextmagicClient.GetUserDedicatedNumbersResponse();
      //expect(instance).to.be.a(TextmagicClient.GetUserDedicatedNumbersResponse);
    });
