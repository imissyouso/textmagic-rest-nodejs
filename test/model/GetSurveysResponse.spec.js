...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TextmagicClient.GetSurveysResponse();
  });
  ...
  describe('GetSurveysResponse', function() {
    it('should create an instance of GetSurveysResponse', function() {
      // uncomment below and update the code to test GetSurveysResponse
      //var instance = new TextmagicClient.GetSurveysResponse();
      //expect(instance).to.be.a(TextmagicClient.GetSurveysResponse);
    });
