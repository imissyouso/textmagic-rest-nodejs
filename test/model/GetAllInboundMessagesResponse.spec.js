...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TextmagicClient.GetAllInboundMessagesResponse();
  });
  ...
  describe('GetAllInboundMessagesResponse', function() {
    it('should create an instance of GetAllInboundMessagesResponse', function() {
      // uncomment below and update the code to test GetAllInboundMessagesResponse
      //var instance = new TextmagicClient.GetAllInboundMessagesResponse();
      //expect(instance).to.be.a(TextmagicClient.GetAllInboundMessagesResponse);
    });
