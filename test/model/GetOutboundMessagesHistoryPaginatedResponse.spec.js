...
(function(root, factory) {
  ...
  describe('GetOutboundMessagesHistoryPaginatedResponse', function() {
    it('should create an instance of GetOutboundMessagesHistoryPaginatedResponse', function() {
      // uncomment below and update the code to test GetOutboundMessagesHistoryPaginatedResponse
      //var instance = new TextmagicClient.GetOutboundMessagesHistoryPaginatedResponse();
