...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TextmagicRest.SurveyRecipient();
  });
  ...
  describe('SurveyRecipient', function() {
    it('should create an instance of SurveyRecipient', function() {
      // uncomment below and update the code to test SurveyRecipient
      //var instance = new TextmagicRest.SurveyRecipient();
      //expect(instance).to.be.a(TextmagicRest.SurveyRecipient);
    });
