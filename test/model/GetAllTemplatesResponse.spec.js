...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TextmagicClient.GetAllTemplatesResponse();
  });
  ...
  describe('GetAllTemplatesResponse', function() {
    it('should create an instance of GetAllTemplatesResponse', function() {
      // uncomment below and update the code to test GetAllTemplatesResponse
      //var instance = new TextmagicClient.GetAllTemplatesResponse();
      //expect(instance).to.be.a(TextmagicClient.GetAllTemplatesResponse);
    });
