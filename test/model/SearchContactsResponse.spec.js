...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TextmagicRest.SearchContactsResponse();
  });
  ...
  describe('SearchContactsResponse', function() {
    it('should create an instance of SearchContactsResponse', function() {
      ...
      //var instance = new TextmagicRest.SearchContactsResponse();
      //expect(instance).to.be.a(TextmagicRest.SearchContactsResponse);
    });
