...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TextmagicClient.SearchListsResponse();
  });
  ...
  describe('SearchListsResponse', function() {
    it('should create an instance of SearchListsResponse', function() {
      // uncomment below and update the code to test SearchListsResponse
      //var instance = new TextmagicClient.SearchListsResponse();
      //expect(instance).to.be.a(TextmagicClient.SearchListsResponse);
    });
