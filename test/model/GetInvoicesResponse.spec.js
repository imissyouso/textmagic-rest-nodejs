...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TextmagicRest.GetInvoicesResponse();
  });
  ...
  describe('GetInvoicesResponse', function() {
    it('should create an instance of GetInvoicesResponse', function() {
      ...
      //var instance = new TextmagicRest.GetInvoicesResponse();
      //expect(instance).to.be.a(TextmagicRest.GetInvoicesResponse);
    });
