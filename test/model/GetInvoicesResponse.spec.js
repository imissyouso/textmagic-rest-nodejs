...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TextmagicClient.GetInvoicesResponse();
  });
  ...
  describe('GetInvoicesResponse', function() {
    it('should create an instance of GetInvoicesResponse', function() {
      ...
      //var instance = new TextmagicClient.GetInvoicesResponse();
      //expect(instance).to.be.a(TextmagicClient.GetInvoicesResponse);
    });
