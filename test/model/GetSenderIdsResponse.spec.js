...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TextmagicClient.GetSenderIdsResponse();
  });
  ...
  describe('GetSenderIdsResponse', function() {
    it('should create an instance of GetSenderIdsResponse', function() {
      // uncomment below and update the code to test GetSenderIdsResponse
      //var instance = new TextmagicClient.GetSenderIdsResponse();
      //expect(instance).to.be.a(TextmagicClient.GetSenderIdsResponse);
    });
