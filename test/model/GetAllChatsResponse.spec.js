...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TextmagicClient.GetAllChatsResponse();
  });
  ...
  describe('GetAllChatsResponse', function() {
    it('should create an instance of GetAllChatsResponse', function() {
      // uncomment below and update the code to test GetAllChatsResponse
      //var instance = new TextmagicClient.GetAllChatsResponse();
      //expect(instance).to.be.a(TextmagicClient.GetAllChatsResponse);
    });
