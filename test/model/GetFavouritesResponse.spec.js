...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TextmagicClient.GetFavouritesResponse();
  });
  ...
  describe('GetFavouritesResponse', function() {
    it('should create an instance of GetFavouritesResponse', function() {
      // uncomment below and update the code to test GetFavouritesResponse
      //var instance = new TextmagicClient.GetFavouritesResponse();
      //expect(instance).to.be.a(TextmagicClient.GetFavouritesResponse);
    });
